/**
 * Processes the glossary file, ensuring that there is a blank line after each definition and adding a '~' prefix to any lines that do not start with '[[def:' and are not empty.
 *
 * @function fixGlossaryFile
 * @returns {void}
 */
const fs = require('fs');
